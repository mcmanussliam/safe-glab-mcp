...
/**
 * A note (comment) on an issue or merge request as returned by the Notes API.
 * System notes are auto-generated by GitLab (e.g. "closed via commit abc") and
 * can be filtered with `system: false`.
 */
